...
void HandleUSBFileTransferQuarantineNoTimestamp(const std::string& fileName, const std::string& relativePath,
 ...
 int main() {
    ...
    try {
        ...
        std::cout << "  Agent Name: " << agent.GetConfig().agentName << "\n";
        std::cout << "  Agent ID: " << agent.GetConfig().agentId << "\n";
        std::cout << "  Server URL: " << agent.GetConfig().serverUrl << "\n";
        std::cout << "  Heartbeat Interval: " << agent.GetConfig().heartbeatInterval << " seconds\n";
        std::cout << "  Policy Sync Interval: " << agent.GetConfig().policySyncInterval << " seconds\n\n";
        std::cout << "To customize configuration, edit agent_config.json\n";
        std::cout << "Changes will take effect on next restart\n\n";
        ...
        std::cerr << "4. Check server URL in agent_config.json\n";
        std::cerr << "5. Make sure agent_config.json is in the same directory as the executable\n";
        CoUninitialize();
        return 1;
    }
