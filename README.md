...
2. Find "CyberSentinel DLP Agent"
...
- **service.log**: General agent activity and information
- **service_error.log**: Errors and warnings

View logs in real-time:
```powershell
Get-Content "C:\Program Files\CyberSentinel\service.log" -Wait -Tail 50
```
...
3. Check error logs:
   ```powershell
   Get-Content "C:\Program Files\CyberSentinel\service_error.log"
   ```
